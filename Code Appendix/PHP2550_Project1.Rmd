...
```{r}
##=== Create a new column about postpartum smoking severity if any of original study or recalled study reported smoking exposure
...
## Overlapping column at 6 month
# subset_post_expo$mom_smoke_expo_6mo <- ifelse(subset_post_expo$mom_smoke_pp6mo=="1" | subset_post_expo$cotimean_pp6mo_baby > 10 | subset_post_expo$cotimean_pp6mo > 10, "1", "0")
## Column about exposure before 6 months
# subset_post_expo$mom_smoke_expo_0to6 <- ifelse(subset_post_expo$mom_smoke_pp1=="1" | subset_post_expo$mom_smoke_pp2=="1" | subset_post_expo$mom_smoke_pp12wk=="1", "1", "0")
# TobExp_df[, c("mom_smoke_pp6mo", "smoke_exposure_6mo", "mom_smoke_pp1", "mom_smoke_pp2", "mom_smoke_pp12wk", "cotimean_pp6mo", "cotimean_pp6mo_baby")]
...
# subset_post_expo[, c("mom_smoke_pp6mo", "smoke_exposure_6mo", "mom_smoke_pp1", "mom_smoke_pp2", "mom_smoke_pp12wk", "cotimean_pp6mo", "cotimean_pp6mo_baby", "smoke_expo_6mo_new")]
